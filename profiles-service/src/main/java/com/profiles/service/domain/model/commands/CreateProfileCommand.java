 ...
 */
public record CreateProfileCommand(Long userId, String firstName, String lastName, LocalDate birthDate, Gender gender,
                                   String phoneNumber, String email, String city, EmergencyContact emergencyContact) {}
